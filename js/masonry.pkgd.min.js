...
;
    ...
    for(var u=o.isBorderBox=!(!p||!n[p]||"border-box"!==n[p]), f=0, c=s.length;
    c>f;
    f++) {
    var d=s[f], l=n[d];
    l=a(t, l);
...
var s, a=function() {
    ...
    for(var t=["webkit", "moz", "ms", "o"], i=0, n=t.length;
    n>i;
    i++) {
...
function n(t) {
    var e=[];
    if(i(t))e=t;
    else if(t&&"number"==typeof t.length)for(var n=0, o=t.length;
    o>n;
    n++)e.push(t[n]);
    else e.push(t);
    return e;
...
, y.prototype._itemize=function(t) {
    for(var e=this._filterFindItemElements(t), i=this.constructor.Item, n=[], o=0, r=e.length;
    r>o;
    o++) {
...
return n;
    ...
    for(var t=[], e=0, i=this.items.length;
    i>e;
    e++)t.push(this.items[e].element);
    return t;
}
...
for(var o=0, r=t.length, s=this, a=0, h=t.length;
    h>a;
    a++) {
    var p=t[a];
    p.on(e, n);
...
, y.prototype.stamp=function(t) {
    ...
    if(t=this._find(t))for(var e=0, i=t.length;
    i>e;
    e++) {
    var n=t[e];
...
, y.prototype._manageStamps=function() {
    ...
    for(var t=0, e=this.stamps.length;
    e>t;
    t++) {
    var i=this.stamps[t];
    this._manageStamp(i);
...
, y.prototype.prepended=function(t) {
    ...
    for(var e=0, i=this.items.length;
    i>e;
    e++) {
    var n=this.items[e];
...
, n.Item.prototype=new m, s(function() {
    for(var e=r(t), i=a.querySelectorAll(".js-"+e), o="data-"+e+"-options", s=0, u=i.length;
    u>s;
    s++) {
...
, p=s+t.size.outerHeight, u=this.cols+1-r.length, f=0;
    u>f;
    f++)this.colYs[a+f]=p;
    return h;
}
...
return e;
    ...
    for(var h=(this.options.isOriginTop?n.top: n.bottom)+i.outerHeight, p=s;
    a>=p;
    p++)this.colYs[p]=Math.max(h, this.colYs[p]);
}
